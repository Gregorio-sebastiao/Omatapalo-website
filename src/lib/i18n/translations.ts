export const translations = {
  ...
  en: {
    ...
    pageTitles: {
      ...
      portefolio: { title: 'Portfolio', eyebrow: 'Omatapalo Group · Projects', outline: 'Projects' },
      pessoas: { title: 'People', eyebrow: 'Omatapalo Group · +15 000 Employees', outline: 'People' },
      contactos: { title: 'Contact', eyebrow: 'Omatapalo Group' },
      media: { title: 'Media', eyebrow: 'Omatapalo Group · News' },
      cdh: { title: 'CDH', eyebrow: 'Omatapalo Group · Sport' },
      ...
      'responsabilidade-social': { title: 'Social Responsibility', eyebrow: 'Omatapalo Group · Mission Make Smile', outline: 'Social' },
    },
    cdh: {
  ...
  fr: {
    ...
    pageTitles: {
      ...
      portefolio: { title: 'Portefeuille', eyebrow: 'Groupe Omatapalo · Projets', outline: 'Projets' },
      pessoas: { title: 'Personnes', eyebrow: 'Groupe Omatapalo · +15 000 Collaborateurs', outline: 'Personnes' },
      contactos: { title: 'Contact', eyebrow: 'Groupe Omatapalo' },
      media: { title: 'Médias', eyebrow: 'Groupe Omatapalo · Actualités' },
      cdh: { title: 'CDH', eyebrow: 'Groupe Omatapalo · Sport' },
