...
export const SECTORS: Sector[] = [
  {
    ...
    companies: [
      { slug: 'fazenda-mumba',  logo: '/Mumba-logo.png',  name: 'Fazenda Mumba', year: '2015', area: 'Agro-negócio',          desc: 'Produção agrícola e pecuária. Detentora de 99,8% do capital social.', link: 'https://fazendamumba.ao/', sector: 'primario', sectorLabel: 'Sector Primário' },
  ...
  },
  {
    ...
    companies: [
      ...
      { slug: 'granisul',    logo: '/GraniSul-Logotipo.png',                 name: 'Granisul',   year: '2010', area: 'Extracção de Granito',     desc: 'Extracção e transformação de granito para construção.', link: 'https://granisul.ao/', sector: 'secundario', sectorLabel: 'Sector Secundário' },
      { slug: 'drillgo',     logo: '/DRILL-GO.png',                          name: 'DrillGo',    year: '2019', area: 'Geotecnia',                desc: 'Obras subterrâneas e geotecnia de precisão.', link: 'https://www.drillgo.com/', sector: 'secundario', sectorLabel: 'Sector Secundário' },
      ...
      { slug: 'emadel',      logo: '/Emadel.png',                            name: 'Emadel',     year: '2010', area: 'Carpintaria',              desc: 'Soluções em madeira para construção e decoração.', link: 'https://emadel.ao/', sector: 'secundario', sectorLabel: 'Sector Secundário' },
  ...
  },
  {
    ...
    companies: [
      { slug: 'investimo-ge',      logo: '/Investimo Ge.png',          name: 'Investimo GE',     year: '2025', area: 'Gestão de Edifícios',        desc: 'Gestão técnica e operacional de edifícios.', link: 'https://www.investimoge.ao/', sector: 'terciario', sectorLabel: 'Sector Terciário' },
